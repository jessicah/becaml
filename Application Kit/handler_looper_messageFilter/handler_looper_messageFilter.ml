...
external b_handler_handler			  : 'a					  -> pointer          = "b_handler_handler"
external b_handler_handler_name       : 'a -> string		  -> pointer          = "b_handler_handler_name"
external b_handler_handler_message    : 'a -> pointer              -> pointer          = "b_handler_handler_message"
external b_handler_                   : pointer                    -> unit        = "b_handler_"   
external b_handler_archive            : pointer -> pointer -> bool      -> status_t = "b_handler_archive"
external b_handler_instantiate        : pointer                    -> pointer          = "b_handler_instantiate"
external b_handler_getSupportedSuites : pointer -> pointer              -> status_t = "b_handler_getSupportedSuites"
external b_handler_lockLooper         : pointer                    -> bool        = "b_handler_lockLooper"
external b_handler_lockLooperWithTimeout : pointer -> bigtime_t -> status_t = "b_handler_lockLooperWithTimeout"
external b_handler_unlockLooper          : pointer -> unit  = "b_handler_unlockLooper"
external b_handler_looper                : pointer -> pointer    = "b_handler_looper"
external b_handler_messageReceived  : pointer -> pointer -> unit = "b_handler_messageReceived"
external b_handler_resolveSpecifier : pointer -> pointer -> int32 -> pointer -> int32 -> string -> pointer = "b_handler_resolveSpecifier_bytecode" "b_handler_resolveSpecifier_native"
external b_handler_setFilterList    : pointer -> pointer -> unit = "b_handler_setFilterList"
external b_handler_filterList       : pointer -> unit -> pointer = "b_handler_filterList"
external b_handler_addFilter        : pointer -> pointer -> unit = "b_handler_addFilter"
external b_handler_removeFilter     : pointer -> pointer -> bool = "b_handler_removeFilter"
external b_handler_setName      : pointer -> string -> unit = "b_handler_setName"
external b_handler_name         : pointer -> unit -> string = "b_handler_name"
external b_handler_setNextHandler                     : pointer -> pointer -> unit = "b_handler_setNextHandler"
external b_handler_nextHandler                        : pointer -> unit -> pointer = "b_handler_nextHandler"
external b_handler_startWatching_handler  : pointer -> pointer -> int32 -> status_t= "b_handler_startWatching_handler"
external b_handler_startWatching_messenger: pointer -> pointer -> int32 -> status_t= "b_handler_startWatching_messenger"
external b_handler_startWatchingAll_handler  : pointer -> pointer -> status_t= "b_handler_startWatchingAll_handler"
external b_handler_startWatchingAll_messenger: pointer -> pointer -> status_t= "b_handler_startWatchingAll_messenger"
external b_handler_stopWatching_handler  : pointer -> pointer -> int32 -> status_t= "b_handler_stopWatching_handler"
external b_handler_stopWatching_messenger: pointer -> pointer -> int32 -> status_t= "b_handler_stopWatching_messenger"
external b_handler_stopWatchingAll_handler  : pointer -> pointer -> status_t= "b_handler_stopWatchingAll_handler"
external b_handler_stopWatchingAll_messenger: pointer -> pointer -> status_t= "b_handler_stopWatchingAll_messenger"

external b_looper_looper_name    : string -> int32 -> int32 -> pointer = "b_looper_looper_name"
external b_looper_looper_archive : pointer -> pointer = "b_looper_looper_archive"
external b_looper_ : pointer -> unit = "b_looper_"
external b_looperForThread : pointer -> thread_id -> pointer = "b_looperForThread"
external b_looper_addCommonFilter : pointer -> pointer -> unit = "b_looper_addCommonFilter"
external b_looper_removeCommonFilter : pointer -> pointer -> bool = "b_looper_removeCommonFilter"
external b_looper_setCommonFilterList : pointer -> pointer -> unit = "b_looper_setCommonFilterList"
external b_looper_addHandler : pointer -> pointer -> unit = "b_looper_addHandler"
external b_looper_removeHandler : pointer -> pointer -> bool = "b_looper_removeHandler"
external b_looper_handlerAt : pointer -> int32 -> pointer = "b_looper_handlerAt"
external b_looper_countHandlers : pointer -> unit -> int32 = "b_looper_countHandlers"
external b_looper_indexOf : pointer -> pointer -> int32 = "b_looper_indexOf"
external b_looper_commonFilterList : pointer -> pointer = "b_looper_commonFilterList"
external b_looper_currentMessage : pointer -> pointer = "b_looper_currentMessage"
external b_looper_detachCurrentMessage : pointer -> pointer = "b_looper_detachCurrentMessage"
external b_looper_dispatchMessage : pointer -> pointer -> pointer -> unit = "b_looper_dispatchMessage"
external b_looper_lock : pointer -> bool = "b_looper_lock"
external b_looper_lockWithTimeout : pointer -> bigtime_t -> unit = "b_looper_lockWithTimeout"
external b_looper_unlock : pointer -> unit = "b_looper_unlock"
external b_looper_lockingThread : pointer -> thread_id = "b_looper_lockingThread"
external b_looper_isLocked : pointer -> bool = "b_looper_isLocked"
external b_looper_countLocks : pointer -> int32 = "b_looper_countLocks"
external b_looper_countLockRequests : pointer -> int32 = "b_looper_countLockRequests"
external b_looper_sem : pointer -> sem_id = "b_looper_sem"
external b_looper_messageReceived : pointer -> pointer -> unit = "b_looper_messageReceived"
external b_looper_messageQueue : pointer -> pointer = "b_looper_messageQueue"
external b_looper_postMessage_message : pointer -> pointer -> status_t = "b_looper_postMessage_message"
external b_looper_postMessage_command : pointer -> int32 -> status_t = "b_looper_postMessage_command"
external b_looper_postMessage_handler_message : pointer -> pointer -> pointer -> status_t = "b_looper_postMessage_handler_message"
external b_looper_postMessage_handler_message_reply : pointer -> pointer -> pointer -> pointer -> status_t = "b_looper_postMessage_handler_message_reply"
external b_looper_postMessage_handler_command : pointer -> pointer -> int32 -> status_t = "b_looper_postMessage_handler_command"
external b_looper_postMessage_handler_command_reply : pointer -> pointer -> int32 -> pointer -> status_t = "b_looper_postMessage_handler_command_reply"
external b_looper_quit : pointer -> unit = "b_looper_quit"
external b_looper_quitRequested : pointer -> bool = "b_looper_quitRequested"
external b_looper_run : pointer -> thread_id = "b_looper_run"
external b_looper_setPreferredHandler : pointer -> pointer -> unit = "b_looper_setPreferredHandler"
external b_looper_preferredHandler : pointer -> pointer = "b_looper_preferredHandler"
external b_looper_thread : pointer -> thread_id = "b_looper_thread"
external b_looper_team : pointer -> team_id = "b_looper_team"
...
external b_MessageFilter_MessageFilter_command : 'a -> int32 -> pointer = "b_MessageFilter_MessageFilter_command"
external b_MessageFilter_filter : pointer -> pointer -> pointer -> filter_result = "b_MessageFilter_filter"
external b_MessageFilter_looper : pointer -> pointer  = "b_MessageFilter_looper"
